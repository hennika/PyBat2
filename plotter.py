...
def plotter(**kwargs):
    ...
    pickle_name, df, cycles, color, color_list, legend_color_list, marker, markerfill, linestyle = plot_support.set_pickle_specs(legend_color_list, **kwargs) # Sets specifications for first pickle
